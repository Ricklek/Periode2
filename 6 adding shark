...
#            randPersonY = round(random.randrange(0, display_height - block_size))#/10.0) * 10.0
        ...
        if lead_x > randSharkX and lead_x < randSharkX + PersonThickness or lead_x + block_size > randSharkX and lead_x + block_size < randSharkX + PersonThickness:
         if lead_y > randSharkY and lead_y < randSharkY + PersonThickness or lead_y + block_size > randSharkY and lead_y + block_size < randSharkY + PersonThickness:
                randSharkX = round(random.randrange(0,
                                                    display_width - block_size))  # /10.0) * 10.0
                randSharkY = round(random.randrange(0,
                                                    display_height - block_size))  # /10.0) * 10.0
         ...
         elif lead_y + block_size > randSharkY and lead_y + block_size < randSharkY + PersonThickness:
            randSharkX = round(random.randrange(0,
                                                 display_width - block_size))  # /10.0) * 10.0
            randSharkY = round(random.randrange(0,
                                                 display_height - block_size))  # /10.0) * 10.0
