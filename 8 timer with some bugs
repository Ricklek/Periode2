...
def gameLoop():
    ...
    while not gameExit:
        ...
        if lead_x > randPersonX and lead_x < randPersonX + PersonThickness or lead_x + block_size > randPersonX and lead_x + block_size < randPersonX + PersonThickness:
        ...
        elif lead_x > randSharkX and lead_x < randSharkX + SharkThickness or lead_x + block_size > randSharkX and lead_x + block_size < randSharkX + SharkThickness:
         if lead_y > randSharkY and lead_y < randSharkY + SharkThickness or lead_y + block_size > randSharkY and lead_y + block_size < randSharkY + SharkThickness:
                randSharkX = round(random.randrange(0,
                                                    display_width - block_size))  # /10.0) * 10.0
                randSharkY = round(random.randrange(0,
                                                    display_height - block_size))  # /10.0) * 10.0
         ...
         elif lead_y + block_size > randSharkY and lead_y + block_size < randSharkY + SharkThickness:
            randSharkX = round(random.randrange(0,
                                                 display_width - block_size))  # /10.0) * 10.0
            randSharkY = round(random.randrange(0,
                                                 display_height - block_size))  # /10.0) * 10.0
